...
--
-- Table structure for table `ArchivePlayer`
--

DROP TABLE IF EXISTS `ArchivePlayer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ArchivePlayer` (
...
--
-- Dumping data for table `ArchivePlayer`
--

LOCK TABLES `ArchivePlayer` WRITE;
/*!40000 ALTER TABLE `ArchivePlayer` DISABLE KEYS */;
/*!40000 ALTER TABLE `ArchivePlayer` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `teamroster` VALUES (1,'Cole','Aydelotte',7,'C',2026),(2,'Cole','Ayd',7,'C',2026),(3,'Brody','Ayd',7,'C',2026);
...
-- Dump completed on 2024-03-26 12:10:50
